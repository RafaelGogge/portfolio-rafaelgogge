      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="flex justify-center items-center gap-4 mb-8">
          <Button
            ...
            variant="outline"
            size="sm"
            className="flex items-center gap-2 bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-700/50"
          >
            {isPlaying ? (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      {project.developmentTime && (
                        <span className="px-3 py-1 bg-zinc-700/50 text-zinc-300 text-sm rounded-full border border-zinc-600/50">
                          {project.developmentTime}
                        </span>
                      )}
                    </div>
          ...
          {selectedProject && (
            ...
            >
              <motion.div
                ...
                className="bg-zinc-900/98 backdrop-blur-xl border border-zinc-700/50 rounded-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden shadow-2xl"
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {projects.map((project, index) => (
          ...
          >
            <div className="bg-gradient-to-br from-zinc-900/95 to-zinc-800/95 backdrop-blur-xl border border-zinc-700/50 rounded-2xl overflow-hidden hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10 h-full flex flex-col">
              {/* Header com imagem */}
              ...
              <div className="p-6 space-y-5 flex-grow flex flex-col">
                ...
                <div className="space-y-3">
                  ...
                  {project.category && (
                    <span className="inline-block px-3 py-1.5 bg-zinc-800/80 text-zinc-300 text-xs rounded-lg font-semibold border border-zinc-700/50">
                      {project.category}
                    </span>
                  )}
                </div>
                        ...
                        {project.features
                          ...
                          .map((feature, featureIndex) => (
                            ...
                            >
                              ...
                              <span className="text-zinc-300 text-xs line-clamp-1">
                                {feature}
                              </span>
                            </div>
                          ))}
                  ...
                  {project.impact && (
                    <div className="p-3 bg-green-500/5 border border-green-500/20 rounded-lg">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-green-300 text-xs leading-relaxed font-medium line-clamp-2">
                          {project.impact}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {project.technologies
                        ...
                        .map((tech, techIndex) => (
                          <Badge
                            key={techIndex}
                            className="bg-zinc-800/60 text-zinc-300 text-xs border-zinc-700/50 hover:bg-zinc-700/80 transition-colors"
                          >
                            {tech}
                          </Badge>
                        ))}
                      {project.technologies.length > 5 && (
                        <Badge className="bg-zinc-800/60 text-zinc-300 text-xs border-zinc-700/50">
                          +{project.technologies.length - 5}
                        </Badge>
                      )}
                    </div>
