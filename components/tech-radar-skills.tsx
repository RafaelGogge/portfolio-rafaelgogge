...
export function TechRadarSkills() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-[600px] md:min-h-[650px] relative bg-gradient-to-br from-zinc-900/95 via-zinc-800/95 to-zinc-900/95 rounded-3xl overflow-hidden p-4 md:p-6 backdrop-blur-xl border border-zinc-700/50">
        ...
        <div
          ...
          style={{
            backgroundImage: `
              ...
              linear-gradient(45deg, transparent 24px, rgba(139, 92, 246, 0.05) 25px, transparent 26px),
              linear-gradient(-45deg, transparent 24px, rgba(34, 197, 94, 0.03) 25px, transparent 26px)
            `,
      ...
      <div className="text-center mb-4 z-30 relative">
        <motion.h2
          className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 via-green-400 to-purple-400 bg-clip-text text-transparent mb-4"
          ...
          <div className={`flex items-center gap-2 px-4 py-2 rounded-full border-2 backdrop-blur-sm ${
            ...
            <motion.div 
              className={`w-3 h-3 rounded-full ${
                radarActive ? "bg-green-400" : "bg-red-400"
              }`}
              animate={{
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isSelected && (
                    <motion.div
                      className="absolute top-full left-1/2 transform -translate-x-1/2 mt-6 bg-zinc-900/98 backdrop-blur-xl border border-zinc-600/60 rounded-2xl p-6 min-w-80 z-50 shadow-2xl"
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {area.skills.map((skill, index) => (
                          <motion.div
                            key={skill.name}
                            className="flex items-center justify-between p-2 bg-zinc-800/50 rounded-lg border border-zinc-700/50"
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3">
                              <div className="w-20 h-3 bg-zinc-700/80 rounded-full overflow-hidden border border-zinc-600/50">
                                <motion.div
                              ...
                              <span 
                                className="text-sm font-bold w-10 text-right font-mono"
                                style={{ color: area.color }}
                              >
                                {skill.level}%
                              </span>
