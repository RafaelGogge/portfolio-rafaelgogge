            ...
            {currentEducation.periods.map((period, index) => (
              ...
              >
                <button
                  ...
                  className="w-full p-4 bg-zinc-800/30 hover:bg-zinc-800/50 transition-colors flex items-center justify-between"
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-8 h-8 rounded-full bg-gradient-to-r ${currentEducation.color} flex items-center justify-center text-sm font-bold text-white`}
                    >
                ...
                {expandedPeriod === period.period && (
                  ...
                  >
                    <p className="text-zinc-300 mb-6">{period.description}</p>
